        ...
        <section id="contact" className="container-site scroll-mt-24 pb-16 md:pb-24">
            <div className="section-panel bg-teal-dark text-center text-cream">
                ...
                <div className="relative py-6 md:py-12">
                    <h2 className="mb-10 text-4xl leading-tight font-extralight sm:text-5xl md:text-6xl">
                        We&apos;d love to hear from you.
                    </h2>
                    <a
                        href={`mailto:${EVENT.email}`}
                        className="btn-pill btn-gold-to-cream px-10 py-5 text-xl font-normal tracking-normal normal-case sm:text-2xl md:px-14 md:py-6"
                    >
                        {EVENT.email}
                    </a>
                </div>
